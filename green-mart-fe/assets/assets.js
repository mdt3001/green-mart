...
export const dummyRatingsData = [
    ...
    { id: "rat_3", rating: 2.1, review: "This product is amazing. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Bessie Cooper', image: profile_pic3 }, productId: "prod_3", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
...
export const ourSpecsData = [
    { title: "Giao hàng nhanh", description: "Tận hưởng giao hàng nhanh chóng đến tận nơi người nhận một cách an toàn  .", icon: SendIcon, accent: '#05DF72' },
    { title: "7 Ngày đổi trả dễ dàng", description: "Thay đổi ý định? Không sao cả. Trả lại bất kỳ mặt hàng nào trong vòng 7 ngày.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Hỗ trợ khách hàng 24/7", description: "Chúng tôi luôn sẵn sàng hỗ trợ bạn. Nhận sự giúp đỡ chuyên nghiệp từ bộ phận hỗ trợ khách hàng của chúng tôi.", icon: HeadsetIcon, accent: '#A684FF' }
]
