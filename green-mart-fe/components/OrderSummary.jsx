    ...
    const handlePlaceOrder = async (e) => {
        ...
        try {
            ...
            if (paymentMethod === "ONLINE" && orderId) {
                ...
                const endpoint = onlinePaymentGateway === "MOMO" 
            ...
            toast.error(err?.message || err.response?.data?.message || "Không thể đặt hàng");
        ...
        <div className='w-full max-w-lg lg:max-w-[340px] bg-slate-50/30 border border-slate-200 text-slate-500 text-sm rounded-xl p-7'>
            ...
            <div className='flex gap-2 items-center mt-1'>
                <input 
                    ...
                    className='accent-gray-500' 
                />
                <label htmlFor="ONLINE" className='cursor-pointer'>Thanh toán online</label>
            </div>
            ...
            {paymentMethod === 'ONLINE' && (
                <div className='ml-6 mt-2 mb-4 space-y-1'>
                    ...
                    <div className='flex gap-2 items-center'>
                        ...
                        />
                        <label htmlFor="VNPAY" className='cursor-pointer'>VNPay</label>
                    </div>
                </div>
            )}
            ...
            <div className='my-4 py-4 border-y border-slate-200 text-slate-400'>
                ...
                {selectedAddress ? (
                    <div className='flex gap-2 items-center mt-2'>
                        <p className='flex-1'>{selectedAddress.name}, {selectedAddress.city}, {selectedAddress.state}, {selectedAddress.zip}</p>
            ...
            <div className='pb-4 border-b border-slate-200'>
                <div className='flex justify-between'>
                    ...
                    <div className='flex flex-col gap-1 font-medium text-right'>
                        ...
                        <p>Miễn phí</p>
                        {couponState.current && (
                            <p>{`-${(couponState.current.discount / 100 * totalPrice).toLocaleString('vi-VN')}${currency}`}</p>
                        )}
                    </div>
                </div>
            ...
            <button 
                onClick={(e) => toast.promise(handlePlaceOrder(e), { loading: 'Đang xử lý...' })} 
