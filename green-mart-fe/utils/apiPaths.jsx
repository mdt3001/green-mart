export const API_PATHS = {
  ...
  ADMIN: {
    ...
    ASSIGN_COUPON_TO_STORES: (code) =>
      `/api/admin/coupons/${code}/assign-stores`,

    // Store Coupon Management
    STORE_COUPONS: (storeId) => `/api/admin/stores/${storeId}/coupons`,
    TOGGLE_STORE_COUPON: (storeId, couponCode) =>
      `/api/admin/stores/${storeId}/coupons/${couponCode}/toggle`,
  },
